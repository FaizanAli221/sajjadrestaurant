...
const FOOD = {
  ...
  karahi:   "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&w=600&q=70",
  ...
  fish:     "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&w=600&q=70",
  ...
  rice:     "https://images.unsplash.com/photo-1512058564366-18510be2db19?auto=format&fit=crop&w=600&q=70",
  dessert:  "https://images.unsplash.com/photo-1563805042-7684c019e1cb?auto=format&fit=crop&w=600&q=70",
  drink:    "https://images.unsplash.com/photo-1544145945-f90425340c7e?auto=format&fit=crop&w=600&q=70",
  salad:    "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&w=600&q=70",
  bread:    "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=600&q=70",
  handi:    "https://images.unsplash.com/photo-1596797038530-2c107229654b?auto=format&fit=crop&w=600&q=70"
};

/* ---- Default Menu (prices in PKR) ---- */
let MENU = [
  // Starters
  { cat:"Starters", name:"Chicken Malai Boti", desc:"Cream-marinated tender chicken cubes off the charcoal grill.", price:"1,150", img:FOOD.tikka },
  { cat:"Starters", name:"Chicken Chargha Bites", desc:"Spiced crispy fried chicken, lemon and chaat masala.", price:"990",  img:FOOD.tikka },
  ...
  { cat:"BBQ", name:"Beef Seekh Kebab", desc:"Slow-charred seasoned beef seekh kebabs with mint raita.", price:"1,250", img:FOOD.seekh },
  { cat:"BBQ", name:"Chicken Tikka (Leg)", desc:"Classic red masala marinated chicken leg, grilled to order.", price:"690",  img:FOOD.tikka },
  { cat:"BBQ", name:"Mutton Chops", desc:"Milk-tenderised juicy chops finished over hot coals.", price:"2,150", img:FOOD.seekh },
  { cat:"BBQ", name:"Chicken Shashlik Sticks", desc:"Marinated chicken, capsicum and onion skewers.", price:"1,190", img:FOOD.tikka },
  { cat:"BBQ", name:"Mixed Grill Platter", desc:"Seekh kebabs, tikka, malai boti and mutton chops platter.", price:"3,450", img:FOOD.seekh },

  // Karahi & Handi
  { cat:"Karahi", name:"Chicken White Karahi", desc:"Silky yoghurt, black pepper and green chilli karahi gravy.", price:"2,250", img:FOOD.karahi },
  { cat:"Karahi", name:"Chicken Makhni Karahi", desc:"Rich tomato and butter gravy finished with fenugreek.", price:"2,350", img:FOOD.karahi },
  { cat:"Karahi", name:"Mutton Karahi", desc:"Fresh bone-in mutton, ginger and traditional whole spices.", price:"3,950", img:FOOD.karahi },
  { cat:"Karahi", name:"Reshmi Paneer Handi", desc:"Cottage cheese cubes in a silky cashew and cream handi.", price:"1,890", img:FOOD.handi },
  { cat:"Karahi", name:"Daal Makhni", desc:"Black lentils simmered overnight with butter and fresh cream.", price:"950",  img:FOOD.handi },
  { cat:"Karahi", name:"Butter Naan", desc:"Freshly baked tandoori naan brushed with pure butter.", price:"150",  img:FOOD.bread },
  ...
  { cat:"Chinese", name:"Chicken Chilli Dry", desc:"Sliced chicken wok-tossed with capsicum, green chilli and onion.", price:"1,490", img:FOOD.chinese },
  { cat:"Chinese", name:"Beef Black Pepper", desc:"Tender sliced beef tossed in rich peppercorn sauce.", price:"1,750", img:FOOD.chinese },
  { cat:"Chinese", name:"Chicken Chow Mein", desc:"Stir-fried egg noodles with julienne chicken & garden veggies.", price:"1,290", img:FOOD.chinese },
  ...
  { cat:"Rice", name:"Mutton Pulao", desc:"Flavorful yakhni rice with tender mutton, fried onion & kachumber.", price:"1,190", img:FOOD.rice },
  { cat:"Rice", name:"Egg Fried Rice", desc:"Wok-tossed basmati rice with fluffy egg and spring onions.", price:"690",  img:FOOD.rice },
  { cat:"Rice", name:"Garlic Rice", desc:"Steamed basmati rice tossed in toasted garlic butter.", price:"650",  img:FOOD.rice },

  // Seafood
  { cat:"Seafood", name:"Grilled Sea Bass", desc:"Whole sea bass grilled with lemon-butter sauce.", price:"2,950", img:FOOD.fish },
  { cat:"Seafood", name:"Fried Fish Fillet", desc:"Golden batter-fried fish fillets served with tamarind dip.", price:"1,850", img:FOOD.fish },
  { cat:"Seafood", name:"Prawn Karahi", desc:"Fresh Arabian sea prawns in tomato and green chilli masala.", price:"2,650", img:FOOD.prawns },
  { cat:"Seafood", name:"Chilli Garlic Prawns", desc:"Wok-tossed jumbo prawns with chilli, garlic and fresh cilantro.", price:"2,450", img:FOOD.prawns },

  // Desserts
  { cat:"Desserts", name:"Sizzling Brownie", desc:"Warm chocolate brownie with vanilla ice cream and hot fudge.", price:"890", img:FOOD.dessert },
  { cat:"Desserts", name:"Gulab Jamun", desc:"Traditional warm gulab jamun in cardamom syrup (2 pcs).", price:"390", img:FOOD.dessert },
  { cat:"Desserts", name:"Kheer", desc:"Slow-cooked rice pudding enriched with pistachios and saffron.", price:"450", img:FOOD.dessert },

  // Drinks
  { cat:"Drinks", name:"Fresh Lime Soda", desc:"Refreshing lime soda, sweet or salted as preferred.", price:"350", img:FOOD.drink },
  { cat:"Drinks", name:"Mint Margarita", desc:"Blended fresh mint leaves, lemon juice and crushed ice.", price:"450", img:FOOD.drink },
  { cat:"Drinks", name:"Kashmiri Chai", desc:"Traditional pink tea with crushed almonds and pistachios.", price:"420", img:FOOD.drink },
  { cat:"Drinks", name:"Soft Drink", desc:"Chilled regular 250ml bottle.", price:"180", img:FOOD.drink }
];
...
const GALLERY = [
  ...
  { src:FOOD.karahi,  alt:"Chicken karahi served in a traditional wok" },
  ...
  { src:FOOD.dessert, alt:"Sizzling brownie with ice cream" },
